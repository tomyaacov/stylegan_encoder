...
class Generator:
    def __init__(self, model, batch_size, clipping_threshold=2, tiled_dlatent=False, model_res=1024, randomize_noise=False):
        ...
        self.dlatents_placeholder = tf.placeholder(self.dlatent_variable.dtype, shape=self.dlatent_variable.shape)
        self.assign_op = tf.assign(self.dlatent_variable, self.dlatents_placeholder)
    ...
    def set_dlatents(self, dlatents):
        ...
        self.sess.run(self.assign_op, feed_dict={self.dlatents_placeholder: dlatents})
