...
def main():
    ...
    parser.add_argument('--src_dir', help='Directory with images for encoding', default='align')
    parser.add_argument('--generated_images_dir', help='Directory for storing generated images', default='gen')
    parser.add_argument('--dlatent_dir', help='Directory for storing dlatent representations', default='emb')
    ...
    parser.add_argument('--video_frame_rate', default=15, help='Video frames per second', type=int)
